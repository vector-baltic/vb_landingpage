  ...
  return (
    <section id="agents" className="relative py-24">
      ...
      <div className="container relative">
        ...
        <Reveal delay={0.15}>
          <div className="group mx-auto max-w-5xl overflow-hidden rounded-2xl border border-border bg-card transition-all duration-300 hover:border-primary/50 hover:shadow-cyan">
